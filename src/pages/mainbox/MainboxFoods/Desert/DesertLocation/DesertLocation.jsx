...
function DesertLocation() {
  ...
  const paramDesert = param.desert
  const findDesert = loc?.foods?.desertlar.find((item) => item?.urlDesert === paramDesert)
