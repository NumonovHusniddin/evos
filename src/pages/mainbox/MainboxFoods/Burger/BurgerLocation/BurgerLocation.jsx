...
function BurgerLocation() {
  const param = useParams()
  const paramBurger = param.burger
  ...
  const findBurger = loc?.foods?.burger.find((item) => item.urlBurger === paramBurger)
