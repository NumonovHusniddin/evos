...
function NewFoodsLocation() {
  const params = useParams();
  const paramsURL = params.food;
  ...
  const findNew = news?.foods?.yangiliklar1.find(
    (item) => item.urla == paramsURL
  );
...
export default NewFoodsLocation;
