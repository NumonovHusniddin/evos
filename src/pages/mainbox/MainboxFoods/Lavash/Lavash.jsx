...
function Lavash() {
  const { data: lavash, isLoading } = UseFetch("https://picdnlswhqdzagojulhf.supabase.co/storage/v1/object/sign/EVOS%20json/db/db.json?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJFVk9TIGpzb24vZGIvZGIuanNvbiIsImlhdCI6MTc0MjU0OTA2MiwiZXhwIjoxNzc0MDg1MDYyfQ.vfpybu2AHKzJbovRgnD81v9jPC4TnvQUpogmDQGtB7w")
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-x-4 gap-y-5">
        {lavash?.foods?.lavash &&
          lavash?.foods?.lavash.map((item, id) => (
            <div
              key={id}
            ...
            >
              ...
              <Link to={`/lavash/${item.urlLavash}`} className="w-full">
