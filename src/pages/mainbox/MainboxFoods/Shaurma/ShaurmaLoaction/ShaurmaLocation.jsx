...
function ShaurmaLocation() {
  ...
  const paramShaurma = param.shaurma
  const findShaurma = loc?.foods?.shaurma.find((item) => item?.urlShaurma === paramShaurma)
  const { t, i18n } = useTranslation()
  const navigate = useNavigate()

  const Back = () => {
    navigate("/menu/shaurma")
  }
...
export default ShaurmaLocation
