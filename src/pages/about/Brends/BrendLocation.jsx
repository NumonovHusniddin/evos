...
function BrendLocation() {
  ...
  return (
    <div className=" pt-[200px] container mb-[280px]">
      <h1 className=" text-green-700 text-center text-[45px] font-bold mb-5 dark:text-white">{findBrend?.title[i18n.language]}</h1>
      <p className=" mb-3 dark:text-white">{findBrend.desc1[i18n.language]}</p>
      <p className=" mb-3 dark:text-white">{findBrend.desc2[i18n.language]}</p>
      <p className=" mb-3 dark:text-white">{findBrend.desc3[i18n.language]}</p>
      <p className=" mb-3 dark:text-white">{findBrend.desc4[i18n.language]}</p>
