            ...
            <div className=" container ">
                <div className="flex flex-col items-center p-5 dark:bg-gray-800 w-[48%] m-auto h-auto border rounded-xl bg-gray-200">
                    ...
                    <textarea
                        ...
                        placeholder={t("comment.s2")}
                        className=" resize-none w-[75%] font-sans text-gray-900 focus:border-green-700 border-[2px] dark:bg-gray-100 p-2 border-gray-300 rounded-lg mb-3 h-[200px] outline-none"
                    />
                    <button
                    ...
                    <h2 className="text-xl mt-5 text-gray-900 font-medium dark:text-gray-200">{t("comment.s4")}</h2>
